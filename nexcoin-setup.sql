-- ============================================================
-- Nexcoin MySQL Setup SQL
-- Run this once on your MySQL database before starting the app
...
CREATE TABLE IF NOT EXISTS `reviews` (
  ...
  CONSTRAINT `reviews_product_id_fk` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- The application will seed the default admin user and
-- site settings automatically on first startup.
-- ============================================================
