      ...
      <div style={{ maxWidth: "520px", margin: "4rem auto", padding: "2rem 1.5rem", textAlign: "center" }}>
        ...
        {state.transactionId && (
          <div style={{ background: "hsla(258,70%,65%,0.08)", border: "1px solid hsla(258,70%,65%,0.2)", borderRadius: "8px", padding: "0.75rem 1rem", marginBottom: "1.5rem", textAlign: "left" }}>
            <p style={{ fontSize: "11px", color: "hsl(var(--muted-foreground))", marginBottom: "2px", textTransform: "uppercase", letterSpacing: "0.05em" }}>Transaction ID</p>
            <p style={{ fontSize: "13px", color: "hsl(var(--foreground))", fontFamily: "monospace", wordBreak: "break-all" }}>{state.transactionId}</p>
          </div>
        )}
