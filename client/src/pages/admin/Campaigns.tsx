...
export default function Campaigns() {
  ...
  return (
    <AdminLayout title="Campaigns" actions={
          ...
          <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
            <button
              ...
              style={{
                ...
                color: announcementEnabled || settings.announcement_enabled === "true" ? "hsl(var(--primary))" : "hsl(var(--muted-foreground))",
        ...
        <div style={{ padding: "14px 20px", borderBottom: "1px solid hsl(var(--border))", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "12px" }}>
          ...
          <button
            ...
            style={{
              ...
              color: bonusEnabled ? "hsl(var(--primary))" : "hsl(var(--muted-foreground))",
              border: "1px solid hsl(var(--border))",
              cursor: "pointer",
              fontWeight: 600,
              whiteSpace: "nowrap",
      ...
      {/* ── Push Notifications ──────────────────────────────────── */}
      <div style={{ ...card, marginTop: "16px", padding: isMobile ? "12px" : "14px" }}>
