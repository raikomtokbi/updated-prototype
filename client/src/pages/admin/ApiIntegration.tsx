...
const inputStyle: React.CSSProperties = {
  ...
  border: "1px solid hsl(var(--border))", borderRadius: "6px", color: "hsl(var(--foreground))",
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
      ...
      <div style={innerCard}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
          ...
          <div>
            <label style={labelStyle}>API Key <span style={{ fontWeight: 400, color: "hsl(var(--muted-foreground))" }}>(x-api-key header)</span></label>
      ...
      <div style={innerCard}>
        ...
        <p style={{ fontSize: "12px", color: "hsl(var(--muted-foreground))", marginBottom: "14px", lineHeight: 1.6 }}>
        ...
        {!isConfigured && (
          <p style={{ fontSize: "11px", color: "hsl(var(--muted-foreground))", marginTop: "8px" }}>Save your API token first to check balance.</p>
        )}
      </div>
    </div>
  );
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              ...
              {fetchError ? (
                <div>
                  ...
                  <button onClick={fetchBusanProducts} disabled={!isConfigured}
                    style={{ marginTop: "6px", padding: "4px 10px", borderRadius: "5px", fontSize: "11px", border: "1px solid hsl(var(--primary) / 0.3)", background: "hsl(var(--primary) / 0.1)", color: "hsl(var(--primary))", cursor: "pointer" }}>
                    Retry
                  </button>
                </div>
              ) : (
      ...
      <div style={{ ...innerCard, padding: 0, overflow: "hidden" }}>
        ...
        {mappings.length === 0 ? (
          <div style={{ padding: "32px 16px", textAlign: "center", color: "hsl(var(--muted-foreground))", fontSize: "12px" }}>
            <Package size={28} style={{ display: "block", margin: "0 auto 10px", color: "hsl(var(--muted-foreground) / 0.5)" }} />
              ...
              <thead>
                <tr style={{ borderBottom: "1px solid hsl(var(--border))" }}>
                  {["CMS Product", "Busan Product ID", "Actions"].map(h => (
                    <th key={h} style={{ padding: "8px 14px", textAlign: "left", color: "hsl(var(--muted-foreground))", fontWeight: 600, fontSize: "11px", whiteSpace: "nowrap" }}>{h}</th>
                  ))}
                </tr>
              </thead>
              <tbody>
                {mappings.map((m) => (
                  <tr key={m.id} style={{ borderBottom: "1px solid hsl(var(--border) / 0.5)" }}>
                    <td style={{ padding: "10px 14px" }}>
                      <div style={{ fontWeight: 500, color: "hsl(var(--foreground))" }}>{m.cmsProductName || m.cmsProductId}</div>
                    </td>
                    <td style={{ padding: "10px 14px" }}>
                      <div style={{ fontFamily: "monospace", fontSize: "11px", color: "hsl(258,80%,72%)", background: "hsl(var(--primary) / 0.08)", padding: "2px 7px", borderRadius: "4px", display: "inline-block" }}>
                        {m.busanProductId}
                      </div>
                      {m.busanProductName && <div style={{ fontSize: "10px", color: "hsl(var(--muted-foreground))", marginTop: "2px" }}>{m.busanProductName}</div>}
                    </td>
                    <td style={{ padding: "10px 14px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "10px", flexWrap: "wrap" }}>
            <button data-testid="button-test-smileone-connection"
              style={{ ...btnPrimary, background: "hsl(var(--card))", border: "1px solid hsl(var(--border))" }}
            ...
            <div key={wh.path} style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
              ...
              <div style={{
                ...
                <button
                  ...
                  style={{ background: "none", border: "none", cursor: "pointer", color: copiedKey === wh.path ? "#4ade80" : "hsl(var(--muted-foreground))", display: "flex", alignItems: "center", flexShrink: 0 }}
                >
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
      <div style={innerCard}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr auto 1fr", gap: "12px", alignItems: "start" }}>
          {/* Left – CMS */}
          <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
            <span style={{ fontSize: "12px", fontWeight: 600, color: "hsl(var(--muted-foreground))", paddingBottom: "6px", borderBottom: "1px solid hsl(var(--border))", display: "block" }}>CMS Product</span>
            <div>
            ...
            {leftGame && (
              <div style={{ display: "flex", flexDirection: "column", gap: "4px", maxHeight: "220px", overflowY: "auto" }}>
                ...
                {!loadingServices && services.length === 0 && (
                  <p style={{ fontSize: "12px", color: "hsl(var(--muted-foreground))" }}>No services for this game.</p>
                )}
                {services.map(svc => (
                  <div key={svc.id} data-testid={`smileone-cms-product-${svc.id}`}
                    ...
                    style={{
                      ...
                      color: "hsl(var(--foreground))", display: "flex", justifyContent: "space-between",
                    }}>
                    <span>{svc.name}</span>
            ...
            {!leftGame && <p style={{ fontSize: "12px", color: "hsl(var(--muted-foreground))" }}>Select a game to see its products.</p>}
          </div>

          {/* Arrow + Map */}
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "8px", paddingTop: "50px" }}>
            <ArrowRight size={18} color="hsl(var(--muted-foreground))" />
          ...
          {/* Right – Smile.one */}
          <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
            <span style={{ fontSize: "12px", fontWeight: 600, color: "hsl(var(--muted-foreground))", paddingBottom: "6px", borderBottom: "1px solid hsl(var(--border))", display: "block" }}>Smile.one Products</span>
            <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "4px", maxHeight: "160px", overflowY: "auto" }}>
              {smileProducts.length === 0 && !fetchingSmile && (
                <p style={{ fontSize: "12px", color: "hsl(var(--muted-foreground))" }}>Enter game slug and fetch to see products.</p>
              )}
              {smileProducts.map(p => (
      ...
      {(selectedService || selectedSmile) && (
        <div style={{ ...innerCard, padding: "10px 14px", display: "flex", alignItems: "center", gap: "10px", fontSize: "12px", color: "hsl(var(--foreground))", flexWrap: "wrap" }}>
          <span style={{ color: selectedService ? "#4ade80" : "hsl(var(--muted-foreground))" }}>
            {selectedService ? `CMS: ${selectedService.name}` : "No CMS product selected"}
          </span>
          <ArrowRight size={12} color="hsl(var(--muted-foreground))" />
          <span style={{ color: selectedSmile ? "#4ade80" : "hsl(var(--muted-foreground))" }}>
      ...
      <div style={{ ...innerCard, padding: 0, overflow: "hidden" }}>
        ...
        {mappings.length === 0 ? (
          <div style={{ padding: "24px 16px", textAlign: "center", color: "hsl(var(--muted-foreground))", fontSize: "12px" }}>
          ...
          <div style={{ overflowX: "auto" }}>
            <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "12px" }}>
              ...
              <tbody>
                {mappings.map(m => (
                  <tr key={m.id} style={{ borderBottom: "1px solid hsl(var(--border) / 0.5)" }}>
                    <td style={{ padding: "9px 14px", color: "hsl(var(--foreground))" }}>{m.gameSlug}</td>
                    <td style={{ padding: "9px 14px", color: "hsl(var(--muted-foreground))" }}>{m.region}</td>
                    <td style={{ padding: "9px 14px", color: "hsl(var(--foreground))" }}>{m.cmsProductName ?? m.cmsProductId}</td>
                    <td style={{ padding: "9px 14px", color: "hsl(var(--foreground))" }}>{m.smileProductName ?? m.smileProductId}</td>
...
function ProviderSection({ slug, label, icon, accentColor, fields, plugins }: ProviderSectionProps) {
  ...
  return (
    <div style={{ border: "1px solid hsl(var(--border))", borderRadius: "8px", overflow: "hidden" }}>
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          <div style={{
            ...
            background: isConfigured ? "rgba(74,222,128,0.08)" : "hsl(var(--border))",
          ...
          <div>
            ...
            {isConfigured
              ...
              : <div style={{ fontSize: "11px", color: "hsl(var(--muted-foreground))", marginTop: "1px" }}>Not configured</div>
            }
          </div>
        </div>
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          <span style={{ fontSize: "11px", color: enabled && isConfigured ? "hsl(142,71%,48%)" : "hsl(var(--muted-foreground))" }}>
      ...
      <div style={{ padding: "14px 16px", display: "flex", flexDirection: "column", gap: "10px", background: "hsl(var(--background))" }}>
        {fields.map((f) => (
          <div key={f.key}>
            <label style={labelStyle}>{f.label}</label>
            <input
  ...
  const renderRow = (
    ...
    <div
      ...
      <div style={{
        ...
        background: configured ? "rgba(74,222,128,0.08)" : "hsl(var(--border))",
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "8px", flexShrink: 0, marginLeft: "auto" }}>
        ...
        <button onClick={onConfigure}
          style={{ display: "inline-flex", alignItems: "center", gap: "5px", padding: "5px 12px", borderRadius: "5px", fontSize: "11px", fontWeight: 600, cursor: "pointer", border: "1px solid hsl(var(--primary) / 0.3)", background: "hsl(var(--primary) / 0.1)", color: "hsl(var(--primary))", whiteSpace: "nowrap", flexShrink: 0 }}
          data-testid={testId}>
