...
export default function UpiPayment() {
      ...
      <div style={{ maxWidth: "520px", margin: "4rem auto", padding: "2rem 1.5rem", textAlign: "center" }}>
        ...
        {orderStatus?.utr && (
          <div style={{ background: "hsla(258,70%,65%,0.08)", border: "1px solid hsla(258,70%,65%,0.2)", borderRadius: "8px", padding: "0.75rem 1rem", marginBottom: "1.5rem", textAlign: "left" }}>
            <p style={{ fontSize: "11px", color: "hsl(var(--muted-foreground))", marginBottom: "2px", textTransform: "uppercase", letterSpacing: "0.05em" }}>UTR Reference</p>
            <p style={{ fontSize: "13px", color: "hsl(var(--foreground))", fontFamily: "monospace", wordBreak: "break-all", margin: 0 }}>{orderStatus.utr}</p>
          </div>
        )}
        ...
        <p style={{ fontSize: "12px", color: "hsl(var(--muted-foreground))", marginTop: "1.5rem" }}>
  ...
  return (
    <div style={{ minHeight: "100vh", background: "hsl(var(--background))", padding: "2rem 1rem" }}>
      <div style={{ maxWidth: "520px", margin: "0 auto" }}>
        ...
        {qrCodeUrl && (
          <div style={{ ...card, marginBottom: "1rem", display: "flex", flexDirection: "column", alignItems: "center", gap: "0.75rem" }}>
            <p style={{ color: "hsl(var(--muted-foreground))", fontSize: "13px", margin: 0 }}>Scan QR Code to Pay</p>
        ...
        {upiId && (
          <div style={{ ...card, marginBottom: "1rem" }}>
            <p style={{ color: "hsl(var(--muted-foreground))", fontSize: "12px", marginBottom: "0.5rem", marginTop: 0 }}>
              Or Pay Using UPI ID
            </p>
            <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", background: "hsl(var(--card))", borderRadius: "0.5rem", padding: "0.75rem 1rem" }}>
              ...
              <button
                ...
                style={{ background: "none", border: "none", cursor: "pointer", color: copied === "upiId" ? "#22c55e" : "hsl(var(--muted-foreground))", padding: "0.25rem", flexShrink: 0 }}
        ...
        <div style={{ ...card, marginBottom: "1rem" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", background: "hsl(var(--card))", borderRadius: "0.5rem", padding: "0.75rem 1rem" }}>
            ...
            <button
              ...
              style={{ background: "none", border: "none", cursor: "pointer", color: copied === "amount" ? "#22c55e" : "hsl(var(--muted-foreground))", padding: "0.25rem", flexShrink: 0 }}
        ...
        <div style={{ ...card, marginBottom: "1.5rem" }}>
          <p style={{ color: "hsl(var(--foreground))", fontSize: "13px", fontWeight: 600, marginTop: 0, marginBottom: "0.75rem" }}>
            How to Pay
          </p>
          <ol style={{ color: "hsl(var(--muted-foreground))", fontSize: "13px", margin: 0, paddingLeft: "1.25rem", lineHeight: 1.8 }}>
            <li>Open Google Pay on your phone</li>
            <li>Scan the QR code OR enter the UPI ID above</li>
            <li>Enter the <strong style={{ color: "hsl(var(--foreground))" }}>exact amount</strong> shown</li>
            <li>Complete the payment and wait for confirmation</li>
          </ol>
          <p style={{ color: "hsl(var(--primary))", fontSize: "12px", marginTop: "0.75rem", marginBottom: 0 }}>
            Your order will be processed automatically once payment is detected.
          </p>
        </div>

        {/* Polling indicator */}
        <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", justifyContent: "center", color: "hsl(var(--muted-foreground))", fontSize: "12px" }}>
