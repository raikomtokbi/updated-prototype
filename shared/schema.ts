...
// ─── Enums ────────────────────────────────────────────────────────────────────
const userRoles = ["super_admin", "admin", "staff", "user"] as const;
const productCategories = ["game_currency", "gift_card", "voucher", "subscription"] as const;
const orderStatuses = ["pending", "processing", "completed", "failed", "refunded"] as const;
const transactionStatuses = ["pending", "success", "failed", "refunded"] as const;
...
export const products = mysqlTable("products", {
  ...
  category: mysqlEnum("category", productCategories).notNull().default("game_currency"),
...
export const tickets = mysqlTable("tickets", {
  ...
  status: mysqlEnum("status", ticketStatuses).notNull().default("open"),
  priority: mysqlEnum("priority", ticketPriorities).notNull().default("medium"),
